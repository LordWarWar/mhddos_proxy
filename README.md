...
- **15.09.2022** Додано автоматичне використання існуючих bypass-методів для захищених цілей 

- **10.09.2022** Внесені зміни в систему отримання проксі для підвищення стабільності роботи.
