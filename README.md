...
Наявний проект цеофіційний форк mhddos_proxy з відкритим кодом з використання мережевого бекенду. Призначений лише для використання задля припинення російської агресії проти України. При несанкціонованому використанні працездатність програми не гарантується і з високою вірогідністю буде припинена. Ми над цим працюємо.
